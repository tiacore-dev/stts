...
@shared_task
def process_and_transcribe_audio_taks_1(file_record, user_id, audio_id, file_extension, transcription_id):
...
@shared_task
def process_and_transcribe_audio_task_2(file_record, user_id, audio_id, file_extension, transcription_id, prompt):
    from app.database.managers.transcription_manager import TranscriptionManager
    db = TranscriptionManager()

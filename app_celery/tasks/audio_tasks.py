...
@shared_task
def process_and_upload_file_task(temp_file_path, user_id, file_name_input, login):
    ...
    file_size = os.path.getsize(temp_file_path)  # Получаем размер файла из локальной системы
